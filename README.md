...
The required output contains three columns:
...
The datasets contain information related to granted patents, inventors, and patent classification information.

The raw USPTO datasets are intentionally **not included in this repository** because of their very large file sizes.
...
The pipeline processes the data programmatically rather than relying on spreadsheet software, allowing the workflow to operate on millions of records.
...
The resulting dataset provides a structured representation of the relationship between inventors, patents, and CPC classifications.
...
This structure can support downstream research involving:
...
GitHub: [anjnesh111-code](https://github.com/anjnesh111-code)
